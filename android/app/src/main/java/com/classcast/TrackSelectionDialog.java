...
public final class TrackSelectionDialog extends DialogFragment {
  ...
  private void init(
    ...
    int videoRenderersIndex = 0;

    for (int i = 0; i < mappedTrackInfo.getRendererCount(); i++) {
      int trackType = mappedTrackInfo.getRendererType(/* rendererIndex= */ i);
      if(trackType == C.TRACK_TYPE_VIDEO){
        videoRenderersIndex = i;
        break;
      }
    }

    int trackType = mappedTrackInfo.getRendererType(/* rendererIndex= */ videoRenderersIndex);
    TrackGroupArray trackGroupArray = mappedTrackInfo.getTrackGroups(videoRenderersIndex);
    TrackSelectionViewFragment tabFragment = new TrackSelectionViewFragment();
    tabFragment.init(
            mappedTrackInfo,
            /* rendererIndex= */ videoRenderersIndex,
            initialParameters.getRendererDisabled(/* rendererIndex= */ videoRenderersIndex),
            initialParameters.getSelectionOverride(/* rendererIndex= */ videoRenderersIndex, trackGroupArray),
            allowAdaptiveSelections,
            allowMultipleOverrides);
    tabFragments.put(videoRenderersIndex, tabFragment);
  ...
  public static final class TrackSelectionViewFragment extends Fragment
    ...
    public View onCreateView(
      ...
      trackSelectionView.setTrackNameProvider(new TrackNames());
  ...
  public static final class TrackNames implements TrackNameProvider{
    private static final String LOW_RES = "Low";
    private static final String Medium_RES = "Medium";
    private static final String HIGH_RES = "High";
    private static final String HD_RES = "HD";
    @Override
    public String getTrackName(Format format) {
      String trackName;
      switch (format.height){
        case 240: trackName = LOW_RES; break;
        case 360: trackName = Medium_RES; break;
        case 480: trackName = HIGH_RES; break;
        case 720: trackName = HD_RES; break;
        default: trackName = "Unknown";
      }
      return trackName;
    }
  }
