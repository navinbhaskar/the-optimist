...
class newLoadingChallenge extends Component {
  ...
  async createChallenge() {
    console.log("dsjdsask: "+this.props.navigation.state.params.username+'||'+this.props.navigation.state.params.name+'||'+this.props.navigation.state.params.subject+'||'+this.props.navigation.state.params.chapter);
    await axios.post('https://classcast-198812.appspot.com/challenge/updated_createChallenge', {
        ...
        "question_count": 10,
        "started_by_sender": false,
        "started_by_receiver": false,
        "completed_by_sender": false,
        "completed_by_receiver": false,
        "sender_marks": 0,
        "receiver_marks": 0,
        "received": false
      })
      .then(res => {
        console.log("dsjdsask: "+res.data.challenge_id);
...
export default newLoadingChallenge
