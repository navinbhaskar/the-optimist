...
class newOngoingTest extends Component {
  ...
  submitTest() {
    ...
    params: {
      ...
      duration: this.props.navigation.state.params.duration * 60,
  ...
  render () {
    ...
    //  console.log("sdaiaskjAS: "+JSON.stringify(this.state.blocks[this.state.selectedSection].data.map(data=> ({attempted: data.attempted}))));
    //console.log("lkxnlksnjkl: "+JSON.stringify(this.props.navigation.state.params.blocks.map(data => ({name: data.section_name, active_question_number: 0}))));
    //console.log("sakjsbgkjbLsadsAA "+JSON.stringify(this.props.navigation.state.params.blocks.filter(pilot => pilot.section_name === "General Awareness")));
    //console.log("sakjsbgkjbLsads "+JSON.stringify(this.props.navigation.state.params));
      return(
        <View style={styles.container}>
          <View style={styles.testHeader}>
            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
              <Progress.Pie progress={(this.props.navigation.state.params.duration * 60 - this.state.timer)/(this.props.navigation.state.params.duration*60)} size={6 * vw} color={'white'} />
            </View>
                ...
                return(
                  ...
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <View style={[styles.textContainer, {marginTop: 1 * vh}]}>
                      { this.state.loading &&
                      <RenderQuestions
                        data={{text: "<p>"+options.value.split('//storage.googleapis.com/classcast_exams_images/').join('https://storage.googleapis.com/classcast_exams_images/').split('https://console.cloud.google.com/storage/browser').join('https://storage.googleapis.com').split('\\\\').join('\\')+"</p>", color: this.state.blocks[this.state.selectedSection].data[this.state.questionIndex].selectedOption == (index+1).toString() ? '#d267db': 'white' }}
                        />
                      }
                    </View>
                  </View>
