...
class newReviewTest extends Component {
  ...
  async componentDidMount() {
    ...
    //console.log("sakjsbgkjsasbLASsads "+JSON.stringify(this.props.navigation.state.params.blocks));
    //console.log("sakjsbgkjbLASsads "+JSON.stringify(this.props.navigation.state.params.blocks.map(data => data.section_name)));
        ...
        <View style={styles.container}>
          <View style={styles.testHeader}>
            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
              <Progress.Pie progress={(this.props.navigation.state.params.timer)/(this.props.navigation.state.params.duration)} size={6 * vw} color={'white'} />
            </View>
              ...
              <View style={{ height: 60 * vh, width: 70 * vw, backgroundColor: 'white', position: 'absolute', alignSelf: 'center', borderRadius: 2*vw }}>
                ...
                <ScrollView style={{width: '100%'}}>
                  <View style={{flexWrap: 'wrap', flexDirection: 'row', marginLeft: 5 * vw, marginRight: 5 * vw}}>
                    {
                    this.props.navigation.state.params.blocks[this.state.selectedSection].data && this.props.navigation.state.params.blocks[this.state.selectedSection].data.map((question, index)=>{
                      return(
          ...
          <ScrollView style={{width: '100%'}}>
            <View style={{height : 5 * vh, width: 50 * vw, marginLeft: 5 * vw, justifyContent: 'center', alignItems: 'center', flexDirection: 'row', backgroundColor: 'rgba(50,50,50,0.9)', borderRadius: 4 * vw, marginTop: 1 * vh}}>
              <Image
                ...
                source={{uri: this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex].attempted ? (this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex].correctOption == this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex].selectedOption) 
              ...
              />
              <Text style={[styles.rightSplitText], {fontSize: 3 * vh, color: '#ffffff' }}>{this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex].attempted ? (this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex].correctOption == this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex].selectedOption)? 'Correct': 'Wrong' : 'Unattempted'}</Text>
            </View>
          { this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex][this.state.language].comp != "" &&
            <View style={styles.textContainer}>
              <RenderQuestions
                data={{text: "<strong>Passage</strong>"+"<p>"+this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex][this.state.language].comp.split('//storage.googleapis.com/classcast_exams_images/').join('https://storage.googleapis.com/classcast_exams_images/').split('https://console.cloud.google.com/storage/browser').join('https://storage.googleapis.com').split('\\\\').join('\\')+"</p>", color: 'white'}}
                />
            </View>
          }
            <View style={styles.textContainer}>
              <RenderQuestions
                data={{text: "<strong>Question</strong>"+"<p>"+this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex][this.state.language].value.split('//storage.googleapis.com/classcast_exams_images/').join('https://storage.googleapis.com/classcast_exams_images/').split('https://console.cloud.google.com/storage/browser').join('https://storage.googleapis.com').split('\\\\').join('\\')+"</p>", color: 'white'}}
                />
            </View>
            { 
              this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex][this.state.language].options && this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex][this.state.language].options.map((options, index)=>{
                return(
                    <View style={[styles.textContainer, {marginTop: 1 * vh}]}>
                      { this.state.loading &&
                      <RenderQuestions
                        data={{text: "<p>"+options.value.split('//storage.googleapis.com/classcast_exams_images/').join('https://storage.googleapis.com/classcast_exams_images/').split('https://console.cloud.google.com/storage/browser').join('https://storage.googleapis.com').split('\\\\').join('\\')+"</p>", color: this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex].correctOption.split('//storage.googleapis.com/classcast_exams_images/').join('https://storage.googleapis.com/classcast_exams_images/').split('https://console.cloud.google.com/storage/browser').join('https://storage.googleapis.com').split('\\\\').join('\\') == (index+1).toString() ? '#80e180': (this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex].selectedOption == (index+1).toString() ? '#f28888': 'white' )}}
                        />
                      }
                    </View>
            ...
            { this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex]['sol'][this.state.language].value != "" &&
              <View style={styles.textContainer}>
                <RenderQuestions
                  data={{text: "<strong>Solution</strong>"+"<p>"+this.props.navigation.state.params.blocks[this.state.selectedSection].data[this.state.questionIndex]['sol'][this.state.language].value.split('//storage.googleapis.com/classcast_exams_images/').join('https://storage.googleapis.com/classcast_exams_images/').split('https://console.cloud.google.com/storage/browser').join('https://storage.googleapis.com').split('\\\\').join('\\')+"</p>", color: 'white'}}
                  />
              </View>
            }
            <View style={{flexDirection: 'row', justifyContent: 'space-around', marginTop: 3 * vh}}>
              ...
              <TouchableNativeFeedback
                onPress={() => {
                  if(this.state.questionIndex != this.props.navigation.state.params.blocks[this.state.selectedSection].data.length-1) {
                    temp = this.state.sections;
                    temp[this.state.selectedSection].active_question_number = this.state.questionIndex+1;
                    this.setState({sections: temp});
                    this.setState({questionIndex: this.state.questionIndex+1});
