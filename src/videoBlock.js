...
class videoBlock extends Component {
  ...
  onLoad = (data) => {
    console.log('videoErrorBufferOnload:')
    this.setState({
      loaded: true,
      paused: false,
  ...
  onBuffer = (data) => {
    console.log("jdidbC "+JSON.stringify(data));
  ...
  renderVideo() {
    return(
      ...
      <Video  
        ...
        onBuffer={(data) => {console.log('videoErrorBuffer:')}}
        onReadyForDisplay={() => { /*Had to manuever temporarily with this but just at the start */
                                console.log('videoErrorBuffer:')
                            }}
        onLoadStart={() => { /*Had to manuever temporarily with this but just at the start */
                                console.log('videoErrorBufferonLoad:')
                            }}
